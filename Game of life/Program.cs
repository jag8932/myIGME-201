...
// Date: 9/30/2020
// Description: The game of life is a simulation of cells within a grid like
// structure. A cell is alive if it has 3 neighbors. If a cell has less than 2 neighbors 
// it will die. If a cell has morre than 3 neighbors it will die due to overcrowding. This
// algorithm can create unique shapes and behavior. For this assignment, I added four more 
// neighbors that the cells can interact with; upperleft, bottomleft, upperright, and bottomright.
            ...
            for (int row = 0; row < MAX_ROWS; ++row)
            {
                for (int col = 0; col < MAX_COLS; ++col)
                {
                    ...
                    for (int nCntr = 0; nCntr < Cell.MAX_NEIGHBORS; ++nCntr)
                    {
                        ...
                        // This switch case function is where we add the other directions topleft, topright, bottomleft, and
                        // bottomright. I have noticed that more colonies of cells are surviving upon adding more directions
                        // that cells can spread. They end up forming ellipse like shapes and some end up in a perpetual state of
                        ...
                        switch (nCntr)
                        {
                            ...
                            case (int)EDirection.up:
                                ...
                                break;
                                // topleft neighbor. We can access this by subtracting a row and a column.
                            ...
                            case (int)EDirection.topright:
                                //topright neighbor. This is accessed by subtracting a row and adding a column.
                            ...
                            case (int)EDirection.bottomleft:
                                //bottomleft neighbor. Accessed one row down and one column behind.
                            ...
                            case (int)EDirection.bottomright:
                                //bottomright neighbor. Accessed one row down and one column in front.
